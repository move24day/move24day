# state_manager.py
# state_manager.py (dispatched_ vehículo 관련 키 삭제)
...
STATE_KEYS_TO_SAVE = [
    ...
    # "dispatched_1t", "dispatched_2_5t", "dispatched_3_5t", "dispatched_5t", # 이 부분 삭제
...
def initialize_session_state(update_basket_callback=None):
    ...
    defaults = {
        ...
        # "dispatched_1t": 0, "dispatched_2_5t": 0, "dispatched_3_5t": 0, "dispatched_5t": 0, # 이 부분 삭제
